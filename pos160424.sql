...
-- Started on 2024-04-16 12:31:14 -04
...
--
-- TOC entry 1958 (class 2604 OID 120989)
...
--
-- TOC entry 1959 (class 2604 OID 120990)
-- Name: id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- TOC entry 1961 (class 2604 OID 120991)
-- Name: id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- TOC entry 1962 (class 2604 OID 120992)
-- Name: id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- TOC entry 1963 (class 2604 OID 120993)
-- Name: id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- TOC entry 1967 (class 2604 OID 120994)
-- Name: id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- TOC entry 1971 (class 2604 OID 120995)
-- Name: id; Type: DEFAULT; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.s_t_holds_id', 96, true);
...
SELECT pg_catalog.setval('public.s_t_holds_items_id', 162, true);
...
SELECT pg_catalog.setval('public.s_t_ventas_id', 93, true);
...
SELECT pg_catalog.setval('public.s_t_ventas_items_id', 100, true);


--
-- TOC entry 2115 (class 0 OID 120904)
-- Dependencies: 173
...
--
-- TOC entry 2117 (class 0 OID 120912)
-- Dependencies: 175
...
--
-- TOC entry 2119 (class 0 OID 120920)
-- Dependencies: 177
...
--
-- TOC entry 2121 (class 0 OID 120929)
-- Dependencies: 179
...
--
-- TOC entry 2123 (class 0 OID 120934)
-- Dependencies: 181
...
--
-- TOC entry 2131 (class 0 OID 120964)
-- Dependencies: 189
...
--
-- TOC entry 2125 (class 0 OID 120939)
-- Dependencies: 183
...
INSERT INTO public.t_productos (id, producto, descripcion, idcategoria, costo, precio, idimpuesto, idunidad, sku, inventario1, costousd, preciousd, utilidad, intipoproducto) VALUES (11, 'Harina de Trigo Leudante', 'Harina de Trigo Leudante Panadero', 9, 50, 60, 2, 2, '004477', 1000.0, 1.37000000000000011, 1.6399999999999999, 20, 1);
...
--
-- TOC entry 2132 (class 0 OID 120967)
-- Dependencies: 190
...
--
-- TOC entry 2133 (class 0 OID 120970)
-- Dependencies: 191
...
--
-- TOC entry 2134 (class 0 OID 120973)
-- Dependencies: 192
...
--
-- TOC entry 2135 (class 0 OID 120976)
-- Dependencies: 193
...
--
-- TOC entry 2127 (class 0 OID 120950)
-- Dependencies: 185
...
--
-- TOC entry 2136 (class 0 OID 120979)
-- Dependencies: 194
...
--
-- TOC entry 2137 (class 0 OID 120985)
-- Dependencies: 195
...
--
-- TOC entry 1977 (class 2606 OID 120997)
...
--
-- TOC entry 1979 (class 2606 OID 120999)
...
--
-- TOC entry 1981 (class 2606 OID 121001)
...
--
-- TOC entry 1985 (class 2606 OID 121003)
...
--
-- TOC entry 1983 (class 2606 OID 121005)
...
--
-- TOC entry 1993 (class 2606 OID 121007)
...
--
-- TOC entry 1987 (class 2606 OID 121009)
...
--
-- TOC entry 1989 (class 2606 OID 121034)
-- Name: t_productos_sku_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY public.t_productos
    ADD CONSTRAINT t_productos_sku_key UNIQUE (sku);


--
-- TOC entry 1995 (class 2606 OID 121011)
...
--
-- TOC entry 1997 (class 2606 OID 121013)
...
--
-- TOC entry 1999 (class 2606 OID 121015)
...
--
-- TOC entry 2001 (class 2606 OID 121017)
...
--
-- TOC entry 1991 (class 2606 OID 121019)
...
--
-- TOC entry 2005 (class 2606 OID 121021)
...
--
-- TOC entry 2003 (class 2606 OID 121023)
...
-- Completed on 2024-04-16 12:31:14 -04
